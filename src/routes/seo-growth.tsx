...
const cards: PortfolioCard[] = [
  ...
  { id: "4", title: "Atlas Real Estate", description: "Local SEO and schema rebuild for 120-property portfolio across 6 cities.", tag: "Real Estate", tagColor: "#E8C07A", thumbnail: <Metric value="+5x" label="Enquiries" />, footer: "5 months · EUROPE" },
